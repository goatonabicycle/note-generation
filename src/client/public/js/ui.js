...
const _patterns = new patterns(Tone, noteObjects, tempoSlider.value, updateUI);

playButton.addEventListener("click", async () => {
    const playing = await _patterns.play();
...
_patterns.updateTempo(initialTempo);